...
void ConsensusMatchingTracker::processFrame(cv::Mat &im_gray, cv::Mat &im_rgba) {
    ...
    cv::putText(im_rgba, message, cv::Point(im_rgba.cols / 2 - 50, im_rgba.rows / 2), cv::FONT_HERSHEY_SIMPLEX, 1, cv::Scalar(0,200,200), 3);
    //mLog(im_rgba, message, cv::Point(im_rgba.cols / 2 - 50, im_rgba.rows / 2));
}
